/*
 Completed by:
 Aki Segismundo, Anwar Benmallouk, Ben Miller, Jionghao Wu, Novan Yang
*/
...
const char PLAYER_SPRITE_FILEPATH[] = "sonic.png",
FRAME_SPRITE_FILEPATH[] = "frame.png",
...
// óóóó PART 1 óóóó //
bool  g_pressedS = false;
int   g_currentCharacter = 0;
...
void draw_text(ShaderProgram* program, GLuint font_texture_id, std::string text, float screen_size, float spacing, glm::vec3 position)
{
    ...
    // Instead of having a single pair of arrays, we'll have a series of pairsóone for each character
...
void initialise()
{
    ...
    // óóóóó INSTANTIATING VIEW AND PROJ MATRICES óóóó //
    g_view_matrix = glm::mat4(1.0f);  // Defines the position (location and orientation) of the camera
    g_projection_matrix = glm::ortho(-5.0f, 5.0f, -3.75f, 3.75f, -1.0f, 1.0f);  // Defines the characteristics of your camera, such as clip planes, field of view, projection method etc.

    // óóóóó CHARACTER óóóó //
...
void update()
{
    // óóóó DELTA TIME CALCULATIONS óóóó //
    ...
    // óóóó PART 3 óóóó //
    if (!g_pressedS) {
        g_animationTimer += delta_time;
        if (g_animationTimer >= 0.4f) {
            g_currentCharacter = (g_currentCharacter + 1) % 4;
            g_animationTimer = 0.0f;
        }
    }
    // óóóó†PART 3 óóóó //

    // óóóó RESETTING MODEL MATRICES óóóó //
    g_character_model_matrix = glm::mat4(1.0f);
    g_frame_model_matrix = glm::mat4(1.0f);
...
void render() {
    ...
    // óóóó†PART 4 óóóó //
    draw_sprite_from_texture_atlas(&g_shader_program, g_character_texture_id, g_currentCharacter, CHARACTER_SHEET_ROWS, CHARACTER_SHEET_COLS);
    // óóóó†PART 4 óóóó //
...
/**
 Start hereówe can see the general structure of a game loop without worrying too much about the details yet.
 */
