...
void initialise()
{
    ...
    g_display_window = SDL_CreateWindow("Survive the Maze!",
...
int main(int argc, char* argv[])
{
    ...
    while (g_game_is_running)
    {
        ...
        if (g_current_scene->m_state.next_scene >= 0){
            std::cout << "Lives:" << g_current_scene->m_state.player_lives << std::endl;
